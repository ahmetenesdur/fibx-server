...
// Re-exporting Hono's JWT middleware configured with our secret
export const authMiddleware = createMiddleware(async (c, next) => {
	...
	try {
		await jwtMiddleware(c, async () => {
			// Continue to next middleware after successful verification
		});

		// Hono JWT middleware sets payload to c.get('jwtPayload')
